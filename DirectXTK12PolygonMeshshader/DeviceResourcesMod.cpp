...
DeviceResourcesMod::DeviceResourcesMod(
...
void DeviceResourcesMod::CreateDeviceResources()
{
#ifdef _GAMING_XBOX
    ...
    m_commandQueue->SetName(L"DeviceResourcesMod");
    ...
    m_rtvDescriptorHeap->SetName(L"DeviceResourcesMod");
    ...
    if (m_depthBufferFormat != DXGI_FORMAT_UNKNOWN)
    {
        ...
        m_dsvDescriptorHeap->SetName(L"DeviceResourcesMod");
    }
    ...
    m_commandList->SetName(L"DeviceResourcesMod");
    ...
    m_fence->SetName(L"DeviceResourcesMod");
...
void DeviceResourcesMod::CreateWindowSizeDependentResources()
{
    if (!m_window)
    {
...
void DeviceResourcesMod::SetWindow(HWND window, int width, int height) noexcept
{
    m_window = window;
...
bool DeviceResourcesMod::WindowSizeChanged(int width, int height)
{
    if (!m_window)
        return false;
...
void DeviceResourcesMod::HandleDeviceLost()
{
...
void DeviceResourcesMod::Prepare(D3D12_RESOURCE_STATES beforeState, D3D12_RESOURCE_STATES afterState)
{
...
void DeviceResourcesMod::Present(D3D12_RESOURCE_STATES beforeState)
{
...
void DeviceResourcesMod::Suspend()
{
#ifdef _GAMING_XBOX
...
void DeviceResourcesMod::Resume()
{
#ifdef _GAMING_XBOX
...
void DeviceResourcesMod::WaitForGpu() noexcept
{
...
void DeviceResourcesMod::MoveToNextFrame()
{
...
void DeviceResourcesMod::GetAdapter(IDXGIAdapter1** ppAdapter)
{
    *ppAdapter = nullptr;
